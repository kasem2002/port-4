interface ProjectVisualProps {
  /** Chooses which generated artwork to render; falls through to a default. */
  id: string;
  className?: string;
}

/**
 * A distinct abstract "product screenshot" per project, drawn as inline SVG so
 * a project with no uploaded image still renders something considered.
 */
